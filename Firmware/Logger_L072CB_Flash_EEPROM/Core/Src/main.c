...
static void MX_RTC_Init(void)
{
  ...
  */
  ...
  /** Enable the WakeUp
  */
  if (HAL_RTCEx_SetWakeUpTimer(&hrtc, 59, RTC_WAKEUPCLOCK_CK_SPRE_16BITS) != HAL_OK)
  {
    Error_Handler();
  }
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, VOUT_VCC_Pin|SPI1_CS_Pin|ENABLE_FLASH_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(USB_RENUM_GPIO_Port, USB_RENUM_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : VOUT_VCC_Pin SPI1_CS_Pin ENABLE_FLASH_Pin */
  GPIO_InitStruct.Pin = VOUT_VCC_Pin|SPI1_CS_Pin|ENABLE_FLASH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : USB_RENUM_Pin */
